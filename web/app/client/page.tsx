...
export default function ClientHome() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Brand Score + Trend + Improvement Opportunities ── */}
      <PortalCard>
        <div className="flex gap-6">
          {/* Left: Score + Sparkline */}
          <div className="flex items-center gap-4 shrink-0 pr-6 border-r border-[#f0f0f0]">
          ...
          {/* Right: Improvement opportunities as list */}
