...
### Client Portal Navigation (role-based sidebar)
...
|-------|---------|-------------|
| **Business** | Business logic & structure | BMC, Value Proposition Canvas, Unit Economics |
...
**Tools** (pinned to sidebar bottom) — Studio, Marketplace, Directorio, Drive, Reportes

**Cuenta** stays in the avatar dropdown (Setup).
...
### Client Portal
Left sidebar with 4 role-based groups (Fundamentos, Inteligencia, Ejecución) plus pinned Tools. Clients create briefs, review deliverables, manage their brand, view analytics, manage their account. AI Copilot assists throughout. Enterprise clients get human Account Executive overlay.
...
7. **Client simplicity over system complexity.** Clients navigate by role-based groups (Fundamentos, Inteligencia, Ejecución) with clear outcomes. The 24 motors and ~125 agents are invisible to them.
